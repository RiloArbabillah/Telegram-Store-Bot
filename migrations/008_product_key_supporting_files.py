"""Migration: add per-item supporting files for AKUN stock.

Run with: python migrations/008_product_key_supporting_files.py
"""
...
def migrate():
    ...
    try:
        ...
        if not changed:
            print("Product key supporting file column already present, skipping")
            return True
